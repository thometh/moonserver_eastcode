...
const ALL_CRYPTOS = ['BTC', 'ETH', 'LTC', 'DASH', 'ZEC', 'BCH', 'MOON']
  ...
  return machineLoader.getMachineNames()
    .then(machineList => ({
      ...
      accounts: [
        ...
        {code: 'moonbank-ticker', display: 'Mock moonbank', class: 'ticker', cryptos: ['MOON']},
        {code: 'bitcoind', display: 'bitcoind', class: 'wallet', cryptos: ['BTC']},
        {code: 'no-layer2', display: 'No Layer 2', class: 'layer2', cryptos: ALL_CRYPTOS},
        {code: 'infura', display: 'Infura', class: 'wallet', cryptos: ['ETH', 'MOON']},
        {code: 'geth', display: 'geth', class: 'wallet', cryptos: ['ETH', 'MOON']},
        ...
        {code: 'moonbank-wallet', display: 'Mock Moonbank', class: 'wallet', cryptos: ['MOON']},
        ...
        {code: 'moonbank-exchange', display: 'Moonbank Exchange', class: 'exchange', cryptos: ['MOON']},
