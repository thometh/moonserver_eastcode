  ...
  return machineLoader.getMachineNames()
    .then(machineList => ({
      ...
      accounts: [
        ...
        {code: 'moonbank-ticker', display: 'Moonbank ticker', class: 'ticker', cryptos: ['MOON']},
        ...
        {code: 'mock-zero-conf', display: 'Mock 0-conf', class: 'zeroConf', cryptos: ['BTC', 'ZEC', 'LTC', 'DASH', 'BCH', 'ETH', 'MOON']}
      ],
