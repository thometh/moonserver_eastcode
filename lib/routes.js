...
function postTx (req, res, next) {
  logger.warn('Firing the postTx function from routes.')
  logger.warn('res.body', req.body)
  logger.warn('res.deviceId', req.deviceId)
  logger.warn('res.settings', req.settings)

  const pi = plugins(req.settings, req.deviceId)
  if (req.body.cryptoCode === 'MOON') {
    logger.warn('MOON Token cash value: ', req.body.fiat)
  }
