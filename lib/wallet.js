...
function fetchWallet (settings, cryptoCode) {
  console.log('###############################');
  console.log('firing fetchWallet in wallet.js');
  console.log('-------------------------------');
  // console.log('fetchWallet settings: ', settings);
  // console.log('fetchWallet cryptoCode: ', cryptoCode);
...
function _balance (settings, cryptoCode) {
  console.log('###############################');
  console.log('firing _balance in wallet.js');
  console.log('-------------------------------');
  // console.log('_balance settings: ', settings);
  // console.log('_balance cryptoCode: ', cryptoCode);
...
function sendCoins (settings, toAddress, cryptoAtoms, cryptoCode) {
  console.log('firing sendCoins in wallet.js');
  // console.log('sendCoins settings: ', settings);
  console.log('sendCoins toAddress: ', toAddress);
  console.log('sendCoins cryptoAtoms: ', cryptoAtoms.toNumber());
  console.log('sendCoins cryptoCode: ', cryptoCode);
  return fetchWallet(settings, cryptoCode)
    .then(r => {
