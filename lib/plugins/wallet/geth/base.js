...
// let isConnected = web.eth.net.isListening();
...
function isStrictAddress (cryptoCode, toAddress) {
  return cryptoCode === 'ETH' || cryptoCode === 'MOON' && util.isValidChecksumAddress(toAddress)
}

function sendCoins (account, toAddress, cryptoAtoms, cryptoCode) {
  console.log('++++++++ SEND COINS IN WALLET/GETH +++++++++')
...
function checkCryptoCode (cryptoCode) {
  ...
  if (cryptoCode === 'MOON') return Promise.resolve()
